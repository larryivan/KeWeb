          ...
          <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6 lg:p-8 border border-gray-100 dark:border-slate-700 h-full transform transition duration-300 hover:shadow-xl">
            ...
            <div class="border-b border-gray-100 dark:border-slate-700 pb-6 mb-6">
              <p class="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
                研究聚焦于人类演化与群体历史，运用古DNA、基因组学、生物信息学、和考古人类学等多学科交叉办法多维度重建古代人类与社会演化历程。
              </p>
              <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
                揭示了亚欧大陆草原人群一万年以来的遗传与文化演变序列，阐明了历史时期蒙古草原人群，包括匈奴、柔然、蒙元等游牧部落的源流，重建百人规模的古代大型家族谱系并推断其家族与社群的婚配习俗、文化传统与社会风貌。以第一（含共一）及共通讯作者在Nature、Cell、Science Advances、Cell Genomics、Current Biology等期刊上发表了多篇论文，研究5次受Nature、Science撰文评述。
              </p>
            </div>
...
const achievements = [
  ...
  '领衔发表全球1001例古代全基因组，占全球已发表古基因组数据库约1/10',
  '研究5次受Nature、Science评述报道，获Nature评述"引领古人类遗传领域新浪潮"',
  '德国马普协会Dieter Rampacher Prize 2021（Max Planck Society）',
  '药康女科学家卓越基金 2025'
];

const teachingInfo = '《基因组学》、《人类进化》、《专业英语》、《Human Evolutionary Genetics》';
const admissionMajors = '人类生物学、生物信息学（面向本/硕/博/博后招生）';
const researchProjects = [
  '国家自然科学基金青年科学基金B类（原优青）（2026–2028）',
  '国家自然科学基金面上项目（2023–2027）',
  '上海市启明星（扬帆）（2023–2026）',
  '海外高层次人才引进启动经费（2022–2027）'
];
